  ...
  <div class="warpper">
    ...
    <div class="table">
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column fixed prop="id" label="日期" width="100">
        </el-table-column>
        <el-table-column prop="productionNum" label="工字轮">
          <el-table-column prop="name" label="B80/33" width="120">
          </el-table-column>
          <el-table-column prop="name" label="B80/17" width="120">
          </el-table-column>
          <el-table-column prop="name" label="B60" width="120">
          </el-table-column>
          <el-table-column prop="name" label="B40" width="120">
          </el-table-column>
          <el-table-column prop="小计" label="B40" width="120">
          </el-table-column>
        </el-table-column>
        <el-table-column prop="client" label="托盘" width="100">
          <el-table-column prop="name" label="塑托" width="120">
          </el-table-column>
          <el-table-column prop="name" label="木托" width="120">
          </el-table-column>
          <el-table-column prop="铁托" label="B40" width="120">
          </el-table-column>
          <el-table-column prop="小计" label="B40" width="120">
          </el-table-column>
        </el-table-column>
