...
import {InDetailWithDay,getCustomerAndSpecification} from '@/api/storeIn'
...
export default {
    ...
    data(){
      return {
        query:{
          time:new Date(new Date()-1000*60*60*24),
          mesCustomer:[],
          mesNormName:[],
          meterLength:"",
          wheelsType:"",
    ...
    methods:{
      ...
      async InDetailWithDay(){
          ...
          const res = await InDetailWithDay(params)
          if(res.code==='0'){
