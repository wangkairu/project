  ...
  <div class="warpper">
    <div class="table-filter">
      ...
      >
        ...
        <el-form-item label="MES轮数">
          <el-input clearable v-model="form.mesNumOfRounds" placeholder="请输入MES轮数"   @change="handelDeptCode"></el-input>
        </el-form-item>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column fixed prop="deptName" label="分厂" width="80">
        </el-table-column>
        <el-table-column
          fixed
          prop="mesNormsName"
        ...
        <el-table-column prop="difference" label="包装出库时差" width="160">
        </el-table-column>
        <el-table-column prop="mesProductionNo" label="MES生产编号" width="175">
        </el-table-column>
        <el-table-column
    ...
    <div class="echarts">
      ...
      >
        ...
        <div
          ...
          style="height: 300px; width: 100%"
        ></div>
        <el-empty style="height: 300px; width: 100%" v-else description="暂无数据"></el-empty>
      </el-card>
...
import { exportDetail,queryList, getDayAmount, getRankBar, getCustomerRank, getNetWeight, getFilterConditions,getNetWeightBYMonth ,getNormsRankBarByMonth} from "@/api/storeIn";
...
export default {
  ...
  methods: {
    async hadelExcel(){
      ...
      const fileName = "成品出库（日）明细表.xlsx";
